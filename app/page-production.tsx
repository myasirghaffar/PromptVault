...
import { HomeClient } from "@/components/home-client-final"
import { Footer } from "@/components/footer"
import { generateMetadata as generateSEOMetadata, generateCanonicalUrl } from "@/lib/seo/metadata-builder"
...
export default async function HomePage() {
  ...
  const categories = Array.from(new Set(transformedPrompts.map((p: any) => p.category)))
